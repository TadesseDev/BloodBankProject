...
class EventBottomSh extends StatefulWidget {
  final Function cancelMap;
  final LatLng locationCoordinate;
  final String areaName,centerName,centerCity;
  EventBottomSh({this.cancelMap,this.centerName,this.centerCity,this.areaName,this.locationCoordinate});
  @override
  _EventBottomShState createState() => _EventBottomShState();
}

class _EventBottomShState extends State<EventBottomSh> {
  @override
